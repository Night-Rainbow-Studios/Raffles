      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 my-5">
        ...
        >
          ...
          <div className="px-4 py-12 md:px-12 md:py-20">
            ...
            <br />
            <a href = "https://wa.me/5555555555" className="mb-6 border-y text-3xl font-bold text-gray-200 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.700/.7),transparent)1] md:mb-12 md:text-4xl">
